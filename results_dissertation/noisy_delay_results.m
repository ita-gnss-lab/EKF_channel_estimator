...
for i = 1:5
    ...
    initialEstimate(1) = initialEstimate(1)*(1);
    configuration.carrierToNoiseDensityRatio = configuration.carrierToNoiseDensityRatio - 25;
...
legend({"25 dB", "0 dB", "-25 dB", "-50 dB", "-75 dB"});
