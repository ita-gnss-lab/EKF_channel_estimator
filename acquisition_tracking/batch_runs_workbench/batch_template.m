...
filter_config.initialDelayErrorSamples   = ...
    simulation_config.samplesPerChip / 8;
filter_config.phaseErrorStd              = pi/8;
...
experimentPrefix = 'testingBatchRuns';

% Preset the batch run
batchVector = [16 32 64];
...
for i = 1:length(batchVector)
    ...
    filter_config.initialDelayErrorSamples   = ...
        simulation_config.samplesPerChip / 8;
    experimentName = [experimentPrefix  '_'  int2str(batchVector(i)) 'Hz'];
